...
class ControlSystem:
    def __init__(self):
        ...
        self.__thrustersOutputsSetpoints    = [0, 0, 0, 0, 0, 0, 0]
        self.__thrustersOutputs             = [0, 0, 0, 0, 0, 0, 0]
        # Operating period
        self.__dt = 1/500
    ...
    def __calculateHorizontalThrust(self):
        ...
        self.__thrustersOutputsSetpoints[self.__thrustersOrder.index(ThrustersNames.H_REAR_LEFT)] = constrain(HRL, -100, 100)
        self.__thrustersOutputsSetpoints[self.__thrustersOrder.index(ThrustersNames.H_REAR_RIGHT)] = constrain(HRR, -100, 100)
